...
__name(cleanBikeForAI, "cleanBikeForAI");
...
`;
    ...
    const outputText = openAIData.output_text || openAIData.output?.[0]?.content?.[0]?.text || "";
    if (!outputText) {
      return jsonResponse(
...
`;
    ...
    const openAiData = await openAiResponse.json();
    const text = openAiData.output_text || openAiData.output?.[0]?.content?.[0]?.text || "";
...
// ../.wrangler/tmp/pages-74ZhmT/functionsRoutes-0.5722585326466.mjs
var routes = [
  {
...
// C:/Users/Jason0977/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/Jason0977/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// C:/Users/Jason0977/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// C:/Users/Jason0977/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-Brsijp/middleware-insertion-facade.js
...
// C:/Users/Jason0977/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-Brsijp/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.958522675118721.mjs.map
