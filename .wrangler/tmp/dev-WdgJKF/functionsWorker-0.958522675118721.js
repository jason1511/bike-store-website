...
// .wrangler/tmp/pages-74ZhmT/functionsWorker-0.958522675118721.mjs
...
__name2(cleanBikeForAI, "cleanBikeForAI");
function cleanJsonText(text) {
  return text.replace(/^```json\s*/i, "").replace(/^```\s*/i, "").replace(/```$/i, "").trim();
}
__name(cleanJsonText, "cleanJsonText");
__name2(cleanJsonText, "cleanJsonText");
...
// .wrangler/tmp/bundle-m6kn6C/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-m6kn6C/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.958522675118721.js.map
